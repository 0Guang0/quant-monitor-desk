...
| B2.5-O-04 | `Layer1ObservationWriter` / `ingestion.py` not implemented                            | **§8.2–8.5 Execute**                          | `backend/app/layer1_axes/ingestion.py`         | No for Phase 1  | `test_layer1Observation_cleanWrite_usesWriteManager`                                   |
