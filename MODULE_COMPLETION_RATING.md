...
> **Machine index:** `MODULE_COMPLETION_RATING.md` · `MIGRATION_MAP.md` · 活规划 → `PROJECT_IMPLEMENTATION_ROADMAP.md` §3。  
...
| --- | ---------------------------------------- | ---------------------------------------------------------------- | --------------------------- | ---- | ------------------------------ | ----------- | -------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| A1  | Project scaffold / config / test harness | `GLOBAL_TESTING_POLICY.md`                                       | `R3_STAGED_FIXTURE_CLOSED`  | 2/3  | pytest + doc links             | R5          | `test_project_scaffold.py`                                                                                           | Batch05                                        |
...
| D4  | Source health snapshot writer  | `ADR-005`, `source_health_writer.py`             | `R2_MINIMAL_VERTICAL_SLICE`         | 1/3     | isolated writer test                    | Batch6      | `ops/source_health_writer.py` · `tests/test_source_health_snapshot.py`（`:memory:`）            | Batch6 production migration                         |
...
| J4  | Docs / task entrypoint consistency | `MIGRATION_MAP.md`                   | `R2_MINIMAL_VERTICAL_SLICE` | 2/3  | manifest + scaffold   | R5          | `tests/test_manifest_files_check.py` · `test_project_scaffold.py`    | Batch05 manifest alignment           |
