...
| Batch 3F-R             | **当前下一执行入口**；R3FR-01 重跑参考采纳治理（护栏 + 覆盖地图边界 + 静态验收）；不改 runtime                                                                                                                          | `docs/implementation_tasks/ROUND_3_REFERENCE_ADOPTION_REFACTOR/BATCH_3FR_REFERENCE_ADOPTION_REFACTOR/`、`specs/contracts/reference_adoption_guardrails.yaml`、`PROJECT_IMPLEMENTATION_ROADMAP.md`、`MODULE_COMPLETION_RATING.md`、`docs/implementation_tasks/PRODUCTION_COMPLETION_VERTICAL_SLICE_PLAN.md`（仅覆盖地图） |
| Round 4/5              | API、前端、Agent、报告通知、回测、集成发布仍以任务包和契约驱动；须等 3F-R→3G→3H 门禁                                                                                                                                    | `docs/implementation_tasks/ROUND_4_API_FRONTEND_AGENT_BACKTEST/`、`docs/implementation_tasks/ROUND_5_INTEGRATION_RELEASE/`                                                                                                                                                                                               |
...
| `PROJECT_IMPLEMENTATION_ROADMAP.md`  | 前向实施规划 SSOT   | Round 3D/3E/3F/3G 及后续 Round 的 forward planning；`ROUND3_BATCH_IMPLEMENTATION_MAP.md` 保留历史批次索引；**地图不是工单，任务卡才是工单** | 否                   |
| `MODULE_COMPLETION_RATING.md`        | 模块完成度快照      | 规划/审计用；不得用文档 alone 冒充 `R6_FULL_PRODUCTION_STABLE`                                                                              | 否                   |
...
| `docs/implementation_tasks/ROUND_3_REFERENCE_ADOPTION_REFACTOR/BATCH_3FR_REFERENCE_ADOPTION_REFACTOR/README.md`                                   | **Batch 3F-R 当前下一执行入口**；参考采纳 refactor                                                       |
| `docs/implementation_tasks/ROUND_3_REFERENCE_ADOPTION_REFACTOR/BATCH_3FR_REFERENCE_ADOPTION_REFACTOR/R3FR_01_REFERENCE_RULES_AND_LICENSE_GATE.md` | R3FR-01 护栏与 license gate 重跑任务卡                                                                   |
| `docs/implementation_tasks/ROUND_3_REFERENCE_ADOPTION_REFACTOR/BATCH_3FR_REFERENCE_ADOPTION_REFACTOR/R3FR_03_TDX_PROVIDER_REFACTOR.md`            | R3FR-03 TDX provider port；`backend/app/datasources/fetch_ports/tdx_pytdx_port.py`、`normalizers/tdx.py` |
| `.trellis/tasks/06-26-round3fr-tdx-provider/`                                                                                                     | R3FR-03 Trellis 执行计划（`EXECUTION_INDEX.md` + frozen）                                                |
...
| 参考项目采纳治理             | `docs/architecture/10_external_references.md`                                                                                              | `specs/contracts/reference_adoption_guardrails.yaml`                                                                                                | `docs/implementation_tasks/ROUND_3_REFERENCE_ADOPTION_REFACTOR/BATCH_3FR_REFERENCE_ADOPTION_REFACTOR/R3FR_01_REFERENCE_RULES_AND_LICENSE_GATE.md`、`BATCH_3FR_HARDENING_RULES.md`、`tests/test_reference_adoption_guardrails.py`；`PRODUCTION_COMPLETION_VERTICAL_SLICE_PLAN.md` 仅覆盖地图 | R3FR-01 不改 runtime；采纳细节在任务卡 `reference_project:` 块                                 |
