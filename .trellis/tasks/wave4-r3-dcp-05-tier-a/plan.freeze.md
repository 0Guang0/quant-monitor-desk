...
| 3.5   | to-issues-slices.md S00–S13                 | [x]  |
...
- Execute GAP：migration 015、9 源 incremental、baostock live
...
- [x] `R3_DCP_05_TIER_A_INCREMENTAL.md` 已读
- [x] `R3_DCP_TO_ISSUES_INDEX.md` §6–§7
- [x] `PROJECT_IMPLEMENTATION_ROADMAP.md` §3.5

### 3.0c 薄三件套

- [x] `freeze-task-card` 已运行
- [x] `frozen/R3_DCP_05_TIER_A_INCREMENTAL.md` 薄指针
