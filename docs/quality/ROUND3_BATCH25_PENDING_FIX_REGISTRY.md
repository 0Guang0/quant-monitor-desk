...
| -------------------------- | -------------------------------------------- | -------------------------------------- | ------------------------------------------------------------------------ | ------------------------- | ------------------------------------------------------------------------------------------------------------ |
| GLOBAL-P2-01 / R3-B2.75-01 | 外部真实源 controlled live pilot 未执行      | **Batch 2.75**（Batch 3 生产宣称之前） | `018B_production_live_pilot_gate.md` · `production_live_pilot_policy.md` | 真实外部源 readiness 宣称 | 授权记录 + 只读 baseline + route dry-run + raw-only micro-fetch + sandbox 校验 + **无生产 DB mutation** 证明 |
...
| B2.5-O-05 / A02-P2-01      | FRED primary vs staged `macro_supplementary` | **Batch 2.75**                         | `ENV-E1-DGS10` · MASTER AC-P2-0                                          | Live FRED shape/授权      | 授权源 route/fetch 证据或保持 staged 并文档化                                                                |
