...
| 1–4   | reference-adoption-dcp07.md                 | [x]  |
| 3.5   | to-issues-slices.md S00–S02                 | [x]  |
...
- Execute GAP：S00 reader、L2-VIX e2e、S02 台账
...
- [x] `R3_DCP_07_LAYER2_CROSS_ASSET.md` 已读
- [x] `R3_DCP_TO_ISSUES_INDEX.md` §6.3
- [x] `PROJECT_IMPLEMENTATION_ROADMAP.md` Wave 4

### 3.0c 薄三件套

- [x] `freeze-task-card` 已运行
- [x] `frozen/R3_DCP_07_LAYER2_CROSS_ASSET.md` 薄指针
