...
> **Status:** **R2a DONE** — `ingestion_evidence.py` merged; **R2b DONE** — `sandbox_bootstrap.py`; **R2c/R2d IN PROGRESS** — `ingestion_commit.py` on branch; verify via I1–I7  
...
PR-R2b  提取 sandbox_bootstrap.py（phase1/2/3/4 共享 DB/data_root 构建）
        backend/app/layer1_axes/sandbox_bootstrap.py
