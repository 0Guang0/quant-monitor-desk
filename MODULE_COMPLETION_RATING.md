...
| A3  | Storage / evidence primitives            | `core_platform`, `docs/modules/local_file_system.md`                                               | `R3_STAGED_FIXTURE_CLOSED`  | 2/3  | R3→R5       | **R3H-08 CLOSED** @ 2026-06-29; **R3-DCP-10 CLOSED** @ `2c5647b5` Layer5 provenance bridge                                                                                   | Wave 5 `R3H-05-GATE` lineage audit.                              |
| A4  | ResourceGuard / performance budget       | `core_platform`, `docs/ops/performance_limits.md`                                                  | `R3_STAGED_FIXTURE_CLOSED`  | 2/3  | R3→R5       | **R3H-08 CLOSED** @ 2026-06-29: caps on live adapter/sync/API paths; **R3-DCP-06 S07**: five-axis panel `P0_ROW_CAPS` + real `ResourceGuard(con).check()` + window_cap tests | Batch05: remaining smoke paths only.                             |
...
| ID  | Module                         | Design authority                                             | Rating                              | 批/3 | Close round | Evidence                                                                                              | Required next movement                                                                                                |
| --- | ------------------------------ | ------------------------------------------------------------ | ----------------------------------- | ---- | ----------- | ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| D1  | Data sync orchestration        | `sync_orchestrator`, `data_sync_orchestrator.md`             | `R4_SANDBOX_REAL_DATA_OR_REHEARSAL` | 2/3  | R3→R5       | **R3-DCP-01/02 CLOSED** @ 2026-06-30; **R3-DCP-09 CLOSED** @ `5ec88389` bounded backfill + nightly CI | Batch6: FullLoad/idempotency edge; `ACC-LIVE-NETWORK-AKSHARE-ENV` nightly 权威。                                      |
...
| G2  | Layer2 cross-asset sensors | `layer2_sensors`, `layer2_cross_asset_sensor.md`   | `R3_STAGED_FIXTURE_CLOSED`  | 2/3  | **R3→R4**   | **R3-DCP-07 CLOSED** @ `3dbf30ea`：L2-VIX `axis_observation`/VIXCLS clean replay e2e + `Layer2CleanObservationReader`  | L3–L4 production_live 全链 → Wave 5 `R3H-05-GATE`。              |
...
| G4  | Layer4 market structure    | `layer4_markets`, `layer4_market_structure.md`     | `R3_STAGED_FIXTURE_CLOSED`  | 2/3  | **R3→R4**   | **R3-DCP-08 CLOSED** @ `d93483f2`：US_EQ tier_a_clean breadth + `test_layer4_us_equity_clean_e2e` + registry reconcile | L3–L4 production_live 全链 → Wave 5 `R3H-05-GATE`。              |
| G5  | Layer5 evidence / security | `layer5_evidence`, `layer5_security_evidence.md`   | `R2_MINIMAL_VERTICAL_SLICE` | 2/3  | **R3→R4**   | **R3-DCP-10 CLOSED** @ `2c5647b5`：mootdx bar → Layer5 provenance e2e + `bundle_layer5_provenance`                     | L3–L4 production_live 全链 → Wave 5 `R3H-05-GATE`；R3H-05 审计。 |
...
- **Round3 data-plane group** (Wave 1–3 **CLOSED** @ 2026-06-30): sync/live/incremental/inspect — see `PROJECT_IMPLEMENTATION_ROADMAP.md` §3.7. **Remaining PASS blockers:** **Wave 5** `R3H-05-GATE`（**Wave 4** `R3-DCP-07..10` @ `2c5647b5` ✅ · **G1/K2 五轴 L1 子集** @ `6c6cdd73` ✅）。
