# task-03-resource-guard · Task Plan

> **planning-with-files 工作记忆** · 序号 03/19 · 阶段：资源守卫
> **模块：** 本机资源守卫（ResourceGuard）
> **README：** `README.md` · **索引：** `../TASK_PIPELINE_INDEX.md`

## Goal

将 **资源守卫** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
...
2. 前置 task 是否已关账？（**task-02 关账后方可开工本票**）
3. 本步最小可运行验证是什么？
...
| 项 | 内容 |
|----|------|
| **前置** | task-02 关账后方可开工本票 |
| **上游** | task-02-source-route-plan |
| **下游** | task-04 及后续重操作 |
