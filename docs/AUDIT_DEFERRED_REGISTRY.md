...
| D3-P1-2                   | C901 write-path — S7 提取式简化关账（2026-07-09） | `docs/decisions/ADR-004-write-path-complexity-ceiling.md` · `ruff --select=C901` · `tests/test_write_manager.py` · `tests/test_source_registry.py` |
