...
| **ADV-FRED-NB01** | NON-BLOCKING | MALFORMED_* mutation 测 | `test_fredEvidenceHealth_malformedBranches_failExplicitly` · `repair-evidence/AA-FRED-A8-01_malformed_health_tests.md` |
