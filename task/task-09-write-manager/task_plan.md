# task-09-write-manager · Task Plan

> **planning-with-files 工作记忆** · 序号 09/19 · 阶段：入库写口
> **模块：** 写库总管（WriteManager / DuckDBWriteManager）
> **README：** `README.md` · **索引：** `../TASK_PIPELINE_INDEX.md`

## Goal

将 **入库写口** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
...
2. 前置 task 是否已关账？（**task-08 关账后方可开工本票**）
3. 本步最小可运行验证是什么？
...
| 项 | 内容 |
|----|------|
| **前置** | task-08 关账后方可开工本票 |
| **上游** | task-07 · task-08 |
| **下游** | task-10 · Layer/API 只读消费 |
