...
This project is indexed by GitNexus as **quant-monitor-desk** (5024 symbols, 7897 relationships, 170 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
