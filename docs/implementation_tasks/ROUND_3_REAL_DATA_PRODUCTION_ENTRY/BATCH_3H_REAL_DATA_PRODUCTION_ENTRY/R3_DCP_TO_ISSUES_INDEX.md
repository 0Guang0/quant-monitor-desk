...
> **状态：** Wave 3 **CLOSED** @ 2026-06-30 · Wave 4 **`R3-DCP-05` CLOSED** @ `c2258363` · **`R3-DCP-06` CLOSED** @ `6c6cdd73` · 下一入口 **`R3-DCP-07..10`**
...
**Wave 3 Done：** DCP-01/02/03 全闭合。**Wave 4 DCP-05 Done：** @ `c2258363` · **DCP-06 Done：** @ `6c6cdd73` · 下一协调入口 **`R3-DCP-07..10`**。

---

## 6. Wave 4 开放项（live 验收承接 · 2026-07-02）

> **状态：** **`R3-DCP-05` ✅ CLOSED** @ `c2258363` · **`R3-DCP-06` ✅ CLOSED** @ `6c6cdd73` · **`R3-DCP-07..10` 🔴 OPEN** · 见 `PROJECT_IMPLEMENTATION_ROADMAP.md` §3.5.2 · `待修复清单.md` §4 / §8  
...
- [x] **R3-DCP-07** — L2-VIX cross-asset 传感器绑 Tier A clean（`test_layer2_vix_clean_e2e` · ADR-032）
- [ ] **R3-DCP-08** — 市场结构 + US 日历
- [ ] **R3-DCP-10** — G5 source_fetch_id / content_hash / schema_hash 绑真源

**承接台账 `ACC-LAYER-E2E-LIVE-001`（L2 子集）：**

- [x] **L2 子集：** L2-VIX clean → snapshot + lineage 非 `staged_fixture_only`（DCP-07 S02）
- [ ] **L3–L5 全链：** 真网 → clean → L3 快照 → L4 结构 → L5 证据 — **阶段外置** → DCP-08/10 + Wave 5 `R3H-05-GATE`
