...
| **B2.5-O-07**    | **PARTIAL→登记** | DataSourceService refactor optional | 双层 fetch_log 保留；lineage 已用 service 权威行 dedupe                                     | `data_quality.py::_collect_fetch_lineage` · `adversarial-audit-phase4-remediation.md` |
