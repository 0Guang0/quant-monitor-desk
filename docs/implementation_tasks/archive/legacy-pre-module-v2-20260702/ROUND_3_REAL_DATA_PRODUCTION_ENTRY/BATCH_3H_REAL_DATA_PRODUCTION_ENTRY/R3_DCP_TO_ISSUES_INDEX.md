# Wave 3–4 — R3-DCP `/to-issues` 任务卡索引（历史 · 只读）

> **⚠️ 2026-07-02：** 本索引 **不再作开工路由**。活 SSOT → [`PROJECT_IMPLEMENTATION_ROADMAP.md`](../../../../../../PROJECT_IMPLEMENTATION_ROADMAP.md) **§3 · 附录 C**。  
> DCP-07/08/10 子集 CLOSED **≠** G2/G4/G5 模块成品 → 由 **M-G2-FULL / M-G4-FULL / M-G5-FULL** 单票承接。  
> 原 Wave 5 → **M-PASS-01**（单票内审计，禁止独立完整流程）。

> **格式：** `/to-issues` · tracer-bullet 垂直切片  
> **波次：** 历史 Wave 3–4（已 CLOSED）  
> **状态：** 全部 CLOSED @ 2026-07-02 · **下一入口见路线图 §3**
...
**Wave 3 Done：** DCP-01/02/03 全闭合。**Wave 4 Done：** DCP-05 @ `c2258363` · DCP-06 @ `6c6cdd73` · DCP-07..10 @ `2c5647b5`（master merge）· 下一入口 **Wave 5 `R3H-05-GATE`**。

---

## 6. Wave 4 开放项（live 验收承接 · 2026-07-02）

> **状态：** **`R3-DCP-05` ✅ CLOSED** @ `c2258363` · **`R3-DCP-06` ✅ CLOSED** @ `6c6cdd73` · **`R3-DCP-07` ✅** · **`R3-DCP-08` ✅** · **`R3-DCP-09` ✅** · **`R3-DCP-10` ✅** @ `2c5647b5` · 见 `PROJECT_IMPLEMENTATION_ROADMAP.md` §3.5.2 · `待修复清单.md` §4 / §8  
...
### 6.2 R3-DCP-06 · 五轴全绿 + L1 子集（L3–L5 阶段外置）— **✅ CLOSED** @ `6c6cdd73`
...
### 6.3 R3-DCP-09 · 有界 backfill + 连网 CI — **✅ CLOSED** @ `5ec88389`

**承接台账：** `WAVE3-ACC-OPT-01` ✅ · `ACC-LIVE-NETWORK-CI-001` ✅ · `ACC-LIVE-ACCEPT-NIGHTLY-001` ✅ · `LIVE-NETWORK-GATE-001` ✅

- [x] `wave3_isolated_production_acceptance.py` `--quick` 跳过 `pytest_full`
- [x] CI nightly：`.github/workflows/nightly.yml` + `pytest --run-network` 子集
- [x] CI nightly：`scripts/wave3_live_production_acceptance.py` + findings 硬门禁
- [ ] `ACC-LIVE-NETWORK-AKSHARE-ENV` — 本地 akshare 环境 **阶段外置** → nightly 权威（`docs/ops/nightly_ci.md`）

### 6.4 其余 Wave 4 活卡（路线图 §3.5.1）

- [x] **R3-DCP-07** — L2-VIX cross-asset 传感器绑 Tier A clean（`test_layer2_vix_clean_e2e` · ADR-032）@ `3dbf30ea`
- [x] **R3-DCP-08** — US_EQ Layer4 clean breadth + registry 三件套（`test_layer4_us_equity_clean_e2e` · ADR-033）@ `d93483f2`
- [x] **R3-DCP-10** — G5 mootdx bar → Layer5 provenance（`test_layer5_mootdx_bar_clean_e2e` · ADR-031）@ `2c5647b5`

**承接台账 `ACC-LAYER-E2E-LIVE-001`（L1/L2/L4/G5 子集）：**

- [x] **L2 子集：** L2-VIX clean → snapshot + lineage 非 `staged_fixture_only`（DCP-07）
- [x] **L4 子集：** US_EQ tier_a_clean e2e（DCP-08）
- [x] **G5 子集：** mootdx bar clean → Layer5 provenance（DCP-10）
- [ ] **L3–L4 production_live 全链：** — **阶段外置** → Wave 5 `R3H-05-GATE`
