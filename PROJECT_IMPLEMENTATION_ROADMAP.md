...
| **R3-DCP-06**                  | **L1 五轴 clean replay 子集**（G12 硬门禁；非 L1–L5 full `production_live` 全链）                                                            | `ACC-LAYER-E2E-LIVE-001`（L1 ✅ · L3–L4 → DCP-07/08 + R3H-05-GATE）            |
...
| **R3-DCP-10**                  | ~~G5 绑真源（mootdx bar → Layer5 provenance）~~ **✅ G5 子集 CLOSED** @ `feature/wave4-r3-dcp-10-evidence`；L3–L4 全链仍 open                 | `ACC-LAYER-E2E-LIVE-001`（G5 ✅ · L3–L4 → DCP-07/08 + R3H-05-GATE）            |
