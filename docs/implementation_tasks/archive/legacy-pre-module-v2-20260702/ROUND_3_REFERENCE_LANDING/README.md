...
| `R3D_018C_live_manual_probe_plan.md`      | Round 3 / Batch 2.75 follow-up / Phase 8D | `debt/r3b275-018c-live-manual-probe-plan`                         | Yes, planning-only          | Prepare future user-authorized `tdx_pytdx` live/manual probe plan; no live fetch in this branch. |
