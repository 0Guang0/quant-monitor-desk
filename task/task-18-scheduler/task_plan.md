# task-18-scheduler · Implementation Plan

> **序号：** 18/19 · **阶段：** Scheduler
> **前置：** task-17 关账后方可开工本票
> **后继：** task-19
> **权威：** `MIGRATION_MAP.md` 索引 → sync_scheduler_profiles.yaml · §13.6

---

## 目标

将 **Scheduler** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
