...
| --------------------- | ---------- | -------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| VR-OPS-001            | 2026-06-25 | db-inspect contract YAML SSOT + drift test (B3V-C01)                 | merge `integration/round3-batch3v` · `backend/app/ops/db_inspector.py` · `specs/contracts/ops_db_inspect_contract.yaml` · `tests/test_contract_drift_ops_write.py`                                                          |
| VR-WRITE-001          | 2026-06-25 | write_contract implemented/reserved modes parity (B3V-C01)           | merge `integration/round3-batch3v` · `specs/contracts/write_contract.yaml` · `tests/test_contract_drift_ops_write.py` · `tests/test_write_manager.py`                                                                       |
| VR-DATA-001           | 2026-06-25 | schema_hash fail-closed runtime slice (B3V-C02; partial registry)    | merge `integration/round3-batch3v` · `skeleton_base._infer_schema_hash` · `validation_gate.py` · `tests/test_db_validation_gate.py`; **remaining:** schemaless registry + non-skeleton paths → Round 3F (`B02-DATA-05`)       |
| VR-STOR-001           | 2026-06-25 | RawStore atomic write via `path_compat.write_bytes_atomic` (B3V-C03) | merge `integration/round3-batch3v` · `backend/app/storage/path_compat.py` · `backend/app/storage/raw_store.py` · `tests/test_raw_store.py`                                                                                    |
| VR-SYNC-002           | 2026-06-25 | sync job support matrix + stable `DeferredJobTypeError` (B3V-C04)    | merge `integration/round3-batch3v` · `backend/app/sync/contract.py` · `specs/contracts/sync_job_contract.yaml` · `tests/test_sync_orchestrator.py` (B3V slice tests)                                                        |
| VR-SYNC-001           | 2026-06-25 | COMPLETED/write crash-window recovery path A (B3V-C04)                 | merge `integration/round3-batch3v` · `recover_stuck_writing_job` · `tests/test_sync_orchestrator.py` (SYNC-05/06); ADR-001 intentional window preserved — not same-tx COMPLETED                                             |
| VR-REG-001            | 2026-06-25 | migration 009 CHECK coverage matrix + registry proposed delta (B3V-C05) | merge `integration/round3-batch3v` · `docs/schema/MIGRATION_COVERAGE.md` · `009_status_check_constraints.sql` · `tests/test_schema_contract.py::test_schemaContract_includesStatusCheckConstraints`                        |
| VR-DOC-001            | 2026-06-25 | `FINAL_AUDIT_REPORT.md` manifest restore + checker (B3V-C05)         | merge `integration/round3-batch3v` · `FINAL_AUDIT_REPORT.md` · `scripts/check_manifest_files.py` · `tests/test_manifest_files_check.py`                                                                                        |
| VR-L5-001             | 2026-06-25 | Layer5 evidence chain stale reconcile (B3V-C06)                      | merge `integration/round3-batch3v` · `376e30e6` baseline + `tests/test_layer5_evidence_chain.py` · `tests/test_layer5_evidence_foundation.py` · `research/l5-reconcile-matrix.md`                                          |
| VR-MODEL-001          | 2026-06-25 | L3/L4/L5 designed vs implemented matrix aligned (B3V-C06)            | merge `integration/round3-batch3v` · `tests/test_migration_coverage.py` · `docs/schema/MIGRATION_COVERAGE.md` · migration gaps re-deferred `R3-MODEL-L3L4-MIGRATION`                                                        |
