# 012_implement_data_adapter_contract 实现 Data Adapter Contract

## 1. 任务目标

实现 BaseDataAdapter、FetchResult、fetch_log。
...
- `backend/sources/base_adapter.py`
- `backend/sources/fetch_result.py`
