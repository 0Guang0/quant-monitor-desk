...
| ----------------------------------------- | -------------------------------------------------------------------------- | --------------------------------------------------------- | ---- | -------------------------------------------------------------------------------------------------------- |
| `test_sync_orchestrator.py`               | `test_syncJobContract_implementedTypes_matchRuntimeCallables`              | YAML implemented == `IMPLEMENTED_JOB_TYPES` == run\_\* 集 | S1   | `pytest tests/test_sync_orchestrator.py::test_syncJobContract_implementedTypes_matchRuntimeCallables -v` |
