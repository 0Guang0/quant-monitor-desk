...
| 目录                 | `.trellis/tasks/m-data-03-tier-a-live/`                                                                                         |
| 分支                 | `feature/m-data-03-tier-a-live`                                                                                                 |
| `task.json` status   | `review`（**未** `finish-work` · 待合并/收尾）                                                                                  |
...
| grill-me 扩批        | **7/7 AC 可勾选** — AC-4 [workflow_dispatch run](https://github.com/0Guang0/quant-monitor-desk/actions/runs/28676746914) 已归档 |
...
| CI 未实跑         | workflow_dispatch 证据                                        | AC-4       |
...
| grill AC 七条                    | **7/7 可勾选**（AC-4 dispatch URL 已归档） | `task.json` → `review`                                          |
...
| **G-05** | 生产前置未验：无二次幂等、无 CI 实跑、沙箱≠生产未入 ADR/MCR、B/C 未覆盖     | §9 #3–#7                                                            | AC-3 · AC-4 · AC-6 · AC-7 | **✅** · 幂等+B/C+ADR+AC-4 dispatch URL 已证             |
...
| AC-4 | ✅ [workflow_dispatch run 28676746914](https://github.com/0Guang0/quant-monitor-desk/actions/runs/28676746914) · `master` · exit 2（缺 secrets；机制已证） |
...
| grill **AC 1–7**                               | **7/7**        | §2.1 · §5 · §2.2 AC 表        | AC-4 dispatch URL 已归档 |
| 用户决策 **full_triple**（幂等+CI+F0）         | **是**         | AC-3 · AC-4 · AC-5 · §9 #3–#5 | 未删，未标完成           |
...
| T-09 | CI **workflow_dispatch** 实跑 11/11 + artifact                               | 原缺口#5 · full_triple · G-05b | AC-4 · §9#4  | ✅ [run 28676746914](https://github.com/0Guang0/quant-monitor-desk/actions/runs/28676746914) · exit 2 缺 secrets |
...
| T-15 | grill AC **7/7 可勾选** + `task.json` → `review`（**非** finish-work）       | G-06                           | §9#9         | ✅ 7/7 · AC-4 URL 已归档                                                                                         |
...
| **AC-4** | CI 实跑：`tier-a-live.yml` workflow_dispatch 全量 11/11 可核对                                           | [GitHub Actions run 28676746914](https://github.com/0Guang0/quant-monitor-desk/actions/runs/28676746914) · exit 2 缺 secrets · 本地 11/11 见 `r2-live-20260703220000` |
...
| **4**  | **G-05b**：CI workflow_dispatch 实跑                                                   | 稳定              | **[x]** AC-4 · [run 28676746914](https://github.com/0Guang0/quant-monitor-desk/actions/runs/28676746914) |
...
| **9**  | `task.json` → `review`（**非** finish-work）/ commit                                   | T-01–T-17 除 T-09 | **[x]** 7/7 AC · AC-4 URL 已归档                                                                         |
...
| CI workflow                  | `.github/workflows/tier-a-live.yml`                                           |
...
_End of handoff — **rev 4.5** · AC-4 dispatch URL 已归档 · `task.json`=`review` · 7/7 AC · T-18 跳过。_
