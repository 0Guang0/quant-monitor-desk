...
10. `ROUND_3_SANDBOX_CLEAN_WRITE/`：Round 3G clean-write rehearsal；**当前下一执行入口**见 `ROUND_3_SANDBOX_CLEAN_WRITE/BATCH_3G_SANDBOX_CLEAN_WRITE/README.md`（3F-R 条件 A 已满足）。
...
> **Current executable entrypoint:** `ROUND_3_SANDBOX_CLEAN_WRITE/BATCH_3G_SANDBOX_CLEAN_WRITE/README.md`  
> **Preconditions:** Round 3F-R **CLOSED** (condition A); `run_data_health_profile` / `market_bar_p0`, provider catalog, TDX delegate boundaries delivered.  
