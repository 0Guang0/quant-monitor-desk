# 018_implement_layer1_interpretation_snapshot 实现 Layer 1 解释快照

## 1. 任务目标

生成 axis_feature_snapshot 与 axis_interpretation_snapshot。
...
- `backend/layers/layer1/feature_engine.py`
- `backend/layers/layer1/interpretation.py`
