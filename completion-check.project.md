...
| selected_source_id or 请求源粉饰选源 | 1 · false-green    | 1    | 2026-07-12 | 2026-07-12 | `completion-check-execute.md` 票 06/07 对象 G（关账前已修 fail-closed）                                       | 报告字段用请求 ID 顶替真实选源 — 审计 JSON / envelope 用 `selected or request_id` 掩盖错选 primary，业务保证坏了仍可能“对得上请求”。 |
...
**Last updated:** 2026-07-12（票 06/07 Execute CLOSED：登记「selected_source_id or 请求源粉饰选源」模式）
