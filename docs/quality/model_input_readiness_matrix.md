...
| `readiness`                      | Meaning                                                                       |
| -------------------------------- | ----------------------------------------------------------------------------- |
| `clean_replay_proven`            | Tier A clean replay e2e proven (DCP-06) — **not** production-live             |
...
| ------------------------ | ------------- | ------------- | ----------------- | ------------------- | -------------------------------------------------- |
| L1-ENV-DGS10             | DGS10         | fred          | primary_candidate | clean_replay_proven | DCP-06 clean replay e2e (B01-FRED live still open) |
| L1-ENV-T10Y3M            | T10Y3M        | fred          | primary_candidate | sandbox_candidate   | raw_staging_pilot (auth required)                  |
| L1-RA-VIXCLS             | VIXCLS        | fred          | primary_candidate | clean_replay_proven | DCP-06 clean replay e2e (B01-FRED live still open) |
