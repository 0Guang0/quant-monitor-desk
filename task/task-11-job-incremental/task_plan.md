# task-11-job-incremental · Implementation Plan

> **序号：** 11/19 · **阶段：** IncrementalUpdateJob
> **前置：** task-10 关账后方可开工本票
> **后继：** task-12
> **权威：** `MIGRATION_MAP.md` 索引 → data_sync_orchestrator.md §12.3

---

## 目标

将 **IncrementalUpdateJob** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
