# task-08-source-conflict-validator · Task Plan

> **planning-with-files 工作记忆** · 序号 08/19 · 阶段：冲突校验
> **模块：** 多源冲突校验（SourceConflictValidator）
> **README：** `README.md` · **索引：** `../TASK_PIPELINE_INDEX.md`

## Goal

将 **冲突校验** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
...
2. 前置 task 是否已关账？（**task-07 关账后方可开工本票**）
3. 本步最小可运行验证是什么？
...
| 项 | 内容 |
|----|------|
| **前置** | task-07 关账后方可开工本票 |
| **上游** | task-06-staging |
| **下游** | task-09-write-manager · task-14-job-reconcile |
