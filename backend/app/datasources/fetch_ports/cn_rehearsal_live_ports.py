"""CN rehearsal/live FetchPort SSOT (R3H-10 S10-05).

Real-network ports for staged pilot and Batch 2.75 live pilot rehearsal.
Product mock/replay ports remain in baostock_port.py / cninfo_port.py / akshare_port.py.
"""
...
@dataclass(frozen=True)
class CninfoRehearsalMetadataFetchPort:
...
# ponytail: staged aliases share SSOT class objects (R3H-10 dual-track convergence)
BaostockStagedFetchPort = BaostockLiveFetchPort
AkshareEquityStagedFetchPort = AkshareEquityLiveFetchPort
CninfoMetadataStagedFetchPort = CninfoRehearsalMetadataFetchPort
