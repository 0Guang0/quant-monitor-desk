...
SOURCE_LIVE_DEFAULTS: dict[str, dict[str, Any]] = {
    ...
    "yahoo_finance": {"symbols": ("AAPL",), "max_rows": 3},
    "akshare": {"symbols": ("sh.600519",), "max_rows": 3},
    "stooq": {"symbols": ("AAPL.US",), "max_rows": 3},
    "coingecko": {"asset_ids": ("bitcoin",), "max_assets": 3},
    "eastmoney": {"symbols": ("sh.600519",), "max_rows": 3},
    "sina_finance": {"symbols": ("sh.600519",), "max_rows": 3},
    ...
    "kalshi": {"market_tickers": ("KXHIGHNY-24",), "max_markets": 1, "use_mock": False},
    "polymarket": {
        "market_slugs": ("will-fed-cut-rates-2024",),
        "max_markets": 1,
        "use_mock": False,
    },
}
