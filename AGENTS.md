...
This project is indexed by GitNexus as **quant-monitor-desk** (3427 symbols, 5323 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
