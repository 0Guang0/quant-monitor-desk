...
class AxisFeatureEngine:
    ...
    def _feature_row(
        ...
        *,
        ...
        percentile_left_tail: float | None = None,
        percentile_right_tail: float | None = None,
        raw_delta_abs: float | None = None,
        raw_delta_pct: float | None = None,
        raw_delta_log: float | None = None,
        level_state: str | None = None,
        ...
        return FeatureSnapshotRow(
            ...
            percentile_left_tail=percentile_left_tail,
            percentile_right_tail=percentile_right_tail,
            raw_delta_abs=raw_delta_abs,
            raw_delta_pct=raw_delta_pct,
            raw_delta_log=raw_delta_log,
            z_score_delta=None,
