...
description: "Plan Phase 5c only — discovers and injects project-specific coding guidelines from .trellis/spec/ before implementation planning is frozen. Complex-task Execute does NOT re-run this skill; read implement.jsonl spec paths + MASTER §12 instead."
---
