...
| `MIGRATION_MAP.md`                                    | 当前项目地图；定位模块设计文档、契约、规则、实现目录入口                          |
...
| Round 3：`017`-`023`                   | 当前执行前必须追溯 Round 2.5、Round 2.6 contract gate、Round 2.6 routing service gate；另读 `docs/ROUND3_HANDOFF.md` 与 `docs/implementation_tasks/ROUND3_EARLY_CLOSE_PLAN.md`                            | 新建 MASTER 时必须把 gate 状态写入 §0/§1/Source Context Index                                           |
