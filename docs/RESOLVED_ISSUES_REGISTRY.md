...
| D3-P1-2                   | 2026-07-01 | C901 on write-path hot functions — ADR wont-fix            | `docs/decisions/ADR-004-write-path-complexity-ceiling.md` · `tests/test_batch6_wave4_prep_closure.py`                                                                                                        |
