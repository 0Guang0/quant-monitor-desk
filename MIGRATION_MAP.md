...
| 五层模型 Layer 1             | `docs/modules/layer1_global_regime_panel.md`                                                                                               | `specs/contracts/layer1_axis_contract.yaml`、`specs/layer1_axes/restructured_axes_v1_1/**`                                                          | `docs/adr/ADR-0003-layer1-standardization-only.md`、`docs/implementation_tasks/ROUND_3_MODELING_LAYERS/017_implement_layer1_axis_loader.md`、`018_implement_layer1_interpretation_snapshot.md`                                            | `backend/app/layer1_axes/`、`configs/layer1_axes.yml`                      |
