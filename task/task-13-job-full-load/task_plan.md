# task-13-job-full-load · Implementation Plan

> **序号：** 13/19 · **阶段：** FullLoadJob
> **前置：** task-12 关账后方可开工本票
> **后继：** task-14
> **权威：** `MIGRATION_MAP.md` 索引 → data_sync_orchestrator.md §12.2

---

## 目标

将 **FullLoadJob** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
