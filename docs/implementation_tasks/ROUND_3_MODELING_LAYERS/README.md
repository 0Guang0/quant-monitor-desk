...
本目录包含 017–023 共 7 个正式 implementation task 文件，并新增 `018A_layer1_observation_ingestion_bridge.md` 作为 Batch 2.5 强制桥接执行文件。必须按 `017` → `018` → `018A` → `019` 顺序进入真实数据相关下游工作。
