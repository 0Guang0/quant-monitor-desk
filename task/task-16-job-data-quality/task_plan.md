# task-16-job-data-quality · Implementation Plan

> **序号：** 16/19 · **阶段：** DataQualityJob
> **前置：** task-15 关账后方可开工本票
> **后继：** task-17
> **权威：** `MIGRATION_MAP.md` 索引 → data_sync_orchestrator.md §13.4.6

---

## 目标

将 **DataQualityJob** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
