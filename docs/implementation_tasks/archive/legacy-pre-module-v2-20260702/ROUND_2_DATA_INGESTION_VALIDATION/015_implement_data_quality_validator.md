# 015_implement_data_quality_validator 实现 DataQualityValidator

## 1. 任务目标

检查空值、重复、日期、schema drift、stale、insufficient history。
...
- 每条 validation rule 必须有 `rule_id`、`rule_version`、`severity`。
