...
| B2.5-O-05 / A02-P2-01      | FRED primary vs staged `macro_supplementary`                                                             | **RE-DEFERRED — Batch 6**      | `ENV-E1-DGS10` · MASTER AC-P2-0 · `production_live_pilot_policy.md` §4 | Live FRED shape/授权        | Request 3 **does not close**; Batch 01 FRED **sandbox** evidence recorded (`fred_pilot_closeout.json`, merge `9ae91648`); live primary closure = user-authorized `FRED:DGS10` pilot + proof (`pytest tests/test_fred_staged_semantics.py`) |
