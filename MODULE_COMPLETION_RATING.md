...
| G2  | Layer2 cross-asset sensors | `layer2_sensors`, `layer2_cross_asset_sensor.md`   | `R3_STAGED_FIXTURE_CLOSED`  | 2/3  | **R3→R4**   | **R3-DCP-07 Execute** @ `feature/wave4-r3-dcp-07-layer2`：L2-VIX `axis_observation`/VIXCLS clean replay e2e + `Layer2CleanObservationReader` | L3–L5 live 子链 → DCP-08/10；Wave 5 `R3H-05-GATE`。                                  |
