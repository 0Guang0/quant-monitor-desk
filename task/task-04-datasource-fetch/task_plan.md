# task-04-datasource-fetch · Task Plan

> **planning-with-files 工作记忆** · 序号 04/19 · 阶段：正式抓取
> **模块：** 数据源抓取模块（DataSourceService / Adapter / Fetch Port）
> **README：** `README.md` · **索引：** `../TASK_PIPELINE_INDEX.md`

## Goal

将 **正式抓取** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
...
2. 前置 task 是否已关账？（**task-03 关账后方可开工本票**）
3. 本步最小可运行验证是什么？
...
| 项 | 内容 |
|----|------|
| **前置** | task-03 关账后方可开工本票 |
| **上游** | task-01～03 |
| **下游** | task-05-raw-store |
