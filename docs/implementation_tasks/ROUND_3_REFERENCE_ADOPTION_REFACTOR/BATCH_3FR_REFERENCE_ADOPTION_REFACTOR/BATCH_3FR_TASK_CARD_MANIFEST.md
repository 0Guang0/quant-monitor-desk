...
| --------- | ------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| `R3FR-01` | `R3FR_01_REFERENCE_RULES_AND_LICENSE_GATE.md`     | Reference-adoption governance becomes enforceable and task-local                                   | `reference_adoption_guardrails.yaml`, roadmap/task indices, `MODULE_COMPLETION_RATING.md`      | No central executable `reference_adoption_inventory.md`        |
