# task-12-job-backfill · Implementation Plan

> **序号：** 12/19 · **阶段：** BackfillJob
> **前置：** task-11 关账后方可开工本票
> **后继：** task-13
> **权威：** `MIGRATION_MAP.md` 索引 → data_sync_orchestrator.md §12.4

---

## 目标

将 **BackfillJob** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
