...
| C2  | DataSourceService facade                     | `datasources`, `datasource_service.md`                                 | `R3_STAGED_FIXTURE_CLOSED`  | 2/3  | R3          | `datasource_service.py`, `test_datasource_service.py`, CLI route-preview/sync-plan                               | **R3H-10:** staged-pilot SSOT — API/Agent/Sync must not bypass service.                                |
