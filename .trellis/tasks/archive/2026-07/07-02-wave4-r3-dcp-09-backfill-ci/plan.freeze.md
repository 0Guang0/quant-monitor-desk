...
| 3.5   | to-issues-slices.md S00–S06                 | [x]  |
...
- `research/integration-audit.md` — **PASS_WITH_GAPS**（GAP owner → Execute S01/S04/S06）
- `research/plan-audit-dcp09.md` — **PASS**（7 findings 全已修复）
- Execute GAP：CLI backfill · nightly workflow · 台账关账
...
- [x] `R3_DCP_09_BOUNDED_BACKFILL_CI.md` 已读
- [x] `R3_DCP_TO_ISSUES_INDEX.md` DCP-09 行
- [x] `PROJECT_IMPLEMENTATION_ROADMAP.md` §3.5

### 3.0c 薄三件套

- [x] `freeze-task-card` 已运行
- [x] `frozen/R3_DCP_09_BOUNDED_BACKFILL_CI.md` 薄指针
