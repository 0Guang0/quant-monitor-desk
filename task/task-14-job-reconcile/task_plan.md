# task-14-job-reconcile · Implementation Plan

> **序号：** 14/19 · **阶段：** ReconcileJob
> **前置：** task-13 关账后方可开工本票
> **后继：** task-15
> **权威：** `MIGRATION_MAP.md` 索引 → data_sync_orchestrator.md §12.6

---

## 目标

将 **ReconcileJob** 做到与设计文档一致的 **R4 成品形态**（本步范围内）。
